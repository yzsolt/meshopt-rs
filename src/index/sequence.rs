...
use super::{decode_v_byte, encode_v_byte, read_byte, write_byte, IndexEncodingVersion, DecodeError};
...
mod test {
    ...
    const INDEX_SEQUENCE_V1: [u8; 13] = [0xd1, 0x00, 0x04, 0xcd, 0x01, 0x04, 0x07, 0x98, 0x1f, 0x00, 0x00, 0x00, 0x00];
	...
	fn encode_test_index_sequence() -> Vec<u8> {
        ...
        buffer.resize_with(encode_index_sequence_bound(INDEX_SEQUENCE.len(), 1001), Default::default);
